...
def decline_word(count: int, word: str) -> str:
    if word == 'рубли':
        current_word = ['рублей', 'рубля', 'рубль']
    elif word == 'года':
        current_word = ['лет', 'года', 'год']
    elif word == 'вакансии':
        current_word = ['вакансий', 'вакансии', 'вакансия']
    elif word == 'разы':
        current_word = ['раза', 'раз']
    elif word == 'скиллы':
        current_word = ['скилла', 'скиллов']
    elif word == 'города':
        current_word = ['города', 'городов']
    else:
        current_word = None
...
def print_cities(cities_list: dict) -> None:
    ...
    for item in cities_list:
        ...
        if current_city_number_of_vacancies >= (len(vacancies) * 9) // 1000:
